...
from .models import FortuneRequest, DailyRequest, FortuneResponse
...
app = FastAPI(title="八字算命 H5 API", version="1.0.0")
...
@app.get("/api/health")
async def health():
    return {"status": "ok", "has_api_key": bool(cfg.api_key)}
